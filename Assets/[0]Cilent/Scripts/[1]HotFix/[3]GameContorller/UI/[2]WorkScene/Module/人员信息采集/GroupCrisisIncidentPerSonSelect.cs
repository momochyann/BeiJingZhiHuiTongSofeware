...
public class GroupCrisisIncidentPerSonSelect : MonoBehaviour, IController
{
    ...
    async UniTask InitAsync()
    {
        ...
        团体危机显示面板 = await this.GetModel<YooAssetPfbModel>().LoadConfig<GameObject>("团体危机显示面板");
        团体危机人员显示面板 = await this.GetModel<YooAssetPfbModel>().LoadConfig<GameObject>("团体危机人员显示面板");
    }
    ...
    void 团体危机人员显示按钮点击()
    {
        ...
        团体危机显示按钮.GetComponentInChildren<Text>().DOColor(Color.black, 0.3f);
