...
public class GroupCrisisIncidentPerSonSelect : MonoBehaviour, IController
{
    ...
    void 团体危机显示按钮点击()
    {
        ...
        团体危机显示按钮.GetComponentInChildren<TMP_Text>().DOColor(选中颜色, 0.3f);
        团体危机显示按钮.GetComponentInChildren<TMP_Text>().fontStyle = FontStyles.Bold;
        团体危机人员显示按钮.GetComponentInChildren<TMP_Text>().fontStyle = FontStyles.Normal;
        团体危机人员显示按钮.GetComponentInChildren<TMP_Text>().DOColor(Color.black * 0.8f, 0.3f);
        是否为事件显示面板 = true;
    ...
    void 团体危机人员显示按钮点击()
    {
        ...
        团体危机显示按钮.GetComponentInChildren<TMP_Text>().DOColor(Color.black * 0.8f, 0.3f);
